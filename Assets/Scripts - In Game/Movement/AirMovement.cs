...
public class AirMovement : Movement 
{
    ...
    void Update()
    {
        ...
        if (flying)
        {
            ...
            //engine.GetComponent<ParticleEmitter>().emit = true;		
        ...
        else
        {
            ...
            //engine.GetComponent<ParticleEmitter>().emit = false;
        ...
        targetAltitude = Mathf.Max(Terrain.activeTerrain.SampleHeight(transform.position) + cruisingAltitude, 0f + cruisingAltitude);
