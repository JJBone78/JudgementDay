...
public class DayNight : MonoBehaviour
{
    ...
    public float YAxisLightRotation = 30;
    ...
    {
        // Update time
        if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.5 && timeInHours - (float)Math.Truncate(timeInHours) < 0.66)
            GUIManager._global_displayed_minute = 0;
        else if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.66 && timeInHours - (float)Math.Truncate(timeInHours) < 0.82)
            GUIManager._global_displayed_minute = 10;
        else if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.82 && timeInHours - (float)Math.Truncate(timeInHours) < 0.98)
            GUIManager._global_displayed_minute = 20;
        else if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.98 || timeInHours - (float)Math.Truncate(timeInHours) < 0.14)
            GUIManager._global_displayed_minute = 30;
        else if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.14 && timeInHours - (float)Math.Truncate(timeInHours) < 0.30)
            GUIManager._global_displayed_minute = 40;
        else if (timeInHours - (float)Math.Truncate(timeInHours) >= 0.30 && timeInHours - (float)Math.Truncate(timeInHours) < 0.5)
            GUIManager._global_displayed_minute = 50;
        ...
        GUIManager._global_displayed_hour = timeInHours;
        if (GUIManager._global_displayed_hour >= 23.5)
            GUIManager._global_displayed_hour = 0;
        else if (GUIManager._global_displayed_hour == 7)
            GUIManager._global_day_night_shift = GUIManager.DayNightShift.Day;
        else if (GUIManager._global_displayed_hour == 19)
            GUIManager._global_day_night_shift = GUIManager.DayNightShift.Night;
        // Update Sun and Moon position
        transform.rotation = Quaternion.Euler(new Vector3(360 / DAY * _timeInSeconds, YAxisLightRotation, 0));
